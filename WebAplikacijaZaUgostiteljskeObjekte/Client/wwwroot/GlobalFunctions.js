window.blazorExtensions = {
    SendLocalEmail: function (mailto, subject, body) {
        ...
        var tekst = "Poštovani, Vaša registracija je odbijena. Razlog:";
        if (!isEmpty(subject)) {
        ...
        if (!isEmpty(body)) {
            ...
            uri = uri + "body=" + tekst + body + ". Lijep pozdrav";
        }
...
window.blazorExtensionss = {
    SendLocalEmailPotvrda: function (mailto, subject, body) {
        var link = document.createElement('a');
        var uri = "mailto:" + mailto + "?";
        if (!isEmpty(subject)) {
            uri = uri + "subject=" + subject;
        ...
        if (!isEmpty(body)) {
            ...
            uri = uri + "body=" + body + " Lijep pozdrav";
        }
